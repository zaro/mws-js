...
(function() {
  var FeedsClient, MWS_FEEDS, XMLFeeds, enums, fs, mws, requests, types,
  ...
  enums = exports.enums = {
    ...
    FeedProcessingStatusList: (function(_super) {
      ...
      function _Class(required, init) {
        var _ref;
        _Class.__super__.constructor.call(this, 'FeedProcessingStatusList', 'Status', ['FillOrKill', 'FillAll', 'FillAllAvailable'], (_ref = options.required) != null ? _ref : false);
      }
