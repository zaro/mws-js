...
(function() {
  var FeedsClient, MWS_FEEDS, MWS_LOCALES, XMLFeeds, enums, fs, mws, requests, types,
  ...
  requests = {
    ...
    SubmitFeed: (function(_super) {
      ...
      function _Class(init, body) {
        ...
        if (_ref1 = this.FeedType != null, __indexOf.call(types.FeedTypes.XML, _ref1) >= 0) {
  ...
  FeedsClient = (function(_super) {
    ...
    FeedsClient.prototype.submitFeed = function(feedType, feedBody, marketplaces, purgeReplace, cb) {
      ...
      req = new requests.SubmitFeed({
        FeedType: feedType,
        MarketplaceIdList: (_ref = marketplaces != null ? marketplaces : this.marketplaceIds) != null ? _ref : [this.marketplaceId],
  ...
  XMLFeeds = (function() {
    function XMLFeeds(options) {
      ...
      this.merchantId = (_ref = options.merchantId) != null ? _ref : null;
    ...
    XMLFeeds.prototype.orderFulfillment = function(orders) {
      var a, cnt, f, fd, head, i, it, items, m, o, xml, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = orders.length; _i < _len; _i++) {
        ...
        _ref = ['AmazonOrderID', 'MerchantOrderID', 'MerchantFulfillmentID'];
        ...
        if (o.FulfillmentData) {
          ...
          _ref1 = ['CarrierCode', 'CarrierName', 'ShippingMethod', 'ShipperTrackingNumber'];
        ...
        for (_l = 0, _len3 = items.length; _l < _len3; _l++) {
          i = items[_l];
          it = f.e('Item');
          _ref2 = ['AmazonOrderItemCode', 'MerchantOrderItemID', 'MerchantFulfillmentItemID', 'Quantity'];
    ...
    XMLFeeds.prototype.productPricing = function(items) {
      var a, cnt, f, head, item, m, xml, _i, _j, _len, _len1, _ref, _ref1;
      ...
      for (_i = 0, _len = items.length; _i < _len; _i++) {
        ...
        _ref = ['StandardPrice', 'MAP'];
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          a = _ref[_j];
          if (item[a]) {
            f.e(a, {
              currency: (_ref1 = item['Currency']) != null ? _ref1 : this.currency
            }, item[a]);
          }
        }
      }
