...
(function() {
  ...
  MWSResponse = (function() {
    ...
    MWSResponse.prototype.parseBody = function(cb) {
      var bodyAsStr, contentType, isXml, md5, parser, ref, ref1;
      isXml = false;
      ...
      if (isXml) {
      ...
      } else if (indexOf.call(this.allowedContentTypes, contentType) >= 0) {
        ...
        this.error = {
          ...
          Message: "Unrecognized content format: " + ((ref1 = this.headers['content-type']) != null ? ref1 : 'undefined')
        };
        this.response = null;
        return cb(this.error, null);
      }
