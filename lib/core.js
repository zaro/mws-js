...
(function() {
  ...
  MWSClient = (function(_super) {
    ...
    function MWSClient() {
      var e, extras, k, options, v, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      if (options.locale != null) {
        ...
        this.amazonDomain = (_ref4 = options.locale.amazonDomain) != null ? _ref4 : void 0;
        this.charset = (_ref5 = options.locale.charset) != null ? _ref5 : 'UTF-8';
      }
      this.host = (_ref6 = this.host) != null ? _ref6 : (_ref7 = options.host) != null ? _ref7 : "mws.amazonservices.com";
      this.port = (_ref8 = options.port) != null ? _ref8 : 443;
      this.merchantId = (_ref9 = options.merchantId) != null ? _ref9 : null;
      this.accessKeyId = (_ref10 = options.accessKeyId) != null ? _ref10 : null;
      this.secretAccessKey = (_ref11 = options.secretAccessKey) != null ? _ref11 : null;
      if (this.marketplaceId == null) {
        this.marketplaceId = (_ref12 = this.marketplaceId) != null ? _ref12 : (_ref13 = options.marketplaceId) != null ? _ref13 : null;
      }
      ...
      this.appHost = (_ref14 = options.appHost) != null ? _ref14 : void 0;
      this.appPlatform = (_ref15 = options.appPlatform) != null ? _ref15 : void 0;
      this.proxy = (_ref16 = options.proxy) != null ? _ref16 : void 0;
      this.strictSSL = (_ref17 = options.strictSSL) != null ? _ref17 : true;
      options;
    }
    ...
    MWSClient.prototype.invoke = function(request, options, cb) {
      var agentParams, h, q, req, reqOptions, v, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      ...
      q = this.sign((_ref = (_ref1 = options.service) != null ? _ref1 : request.service) != null ? _ref : null, request.query((_ref2 = options.query) != null ? _ref2 : {}));
      ...
      reqOptions = {
        ...
        uri: url.format({
          ...
          port: this.port,
          protocol: 'https:',
          pathname: (_ref4 = (_ref5 = options.path) != null ? _ref5 : (_ref6 = request.service) != null ? _ref6.path : void 0) != null ? _ref4 : '/',
          search: (_ref7 = options.qs) != null ? _ref7 : ''
        }),
      ...
      req = HTTPSRequest(reqOptions, (function(_this) {
        return function(error, response, body) {
          ...
          return mwsres.parseBody(function(err, parsed) {
            var invokeOpts, nextRequest, _ref10, _ref8, _ref9;
            if ((options.nextTokenCall != null) && (((_ref8 = mwsres.result) != null ? (_ref9 = _ref8.NextToken) != null ? _ref9.length : void 0 : void 0) > 0)) {
              invokeOpts = {
              ...
              if (options.nextTokenCallUseHasNext) {
                ...
                if (((_ref10 = mwsres.result) != null ? _ref10.HasNext : void 0) === 'true') {
  ...
  MWSResponse = (function() {
    ...
    MWSResponse.prototype.parseBody = function(cb) {
      var bodyAsStr, contentType, isXml, md5, parser, _ref, _ref1, _ref2;
      isXml = false;
      contentType = (_ref = this.headers['content-type']) != null ? _ref : 'text/plain';
      ...
      if (isXml) {
        ...
        return parser.parseString(this.body, (function(_this) {
          return function(err, res) {
            var k, rtype, v, _ref1, _ref2;
            if (err) {
              throw err;
            } else {
              _this.response = res != null ? res : {};
              _ref1 = _this.response;
              for (k in _ref1) {
                v = _ref1[k];
                ...
                if (rtype) {
                  ...
                  if (_this.responseType === 'Error') {
                    _this.error = (_ref2 = v.Error) != null ? _ref2 : v;
                    _this.requestI;
                  }
      ...
      } else if (_ref1 = this.headers['content-type'], __indexOf.call(this.allowedContentTypes, _ref1) >= 0) {
        ...
        this.error = {
          ...
          Message: "Unrecognized content format: " + ((_ref2 = this.headers['content-type']) != null ? _ref2 : 'undefined')
        };
        this.response = null;
        return cb(this.error, null);
      }
  ...
  MWSTimestamp = (function(_super) {
    ...
    MWSTimestamp.prototype.get = function() {
      var _ref;
      if (((_ref = this.value) != null ? _ref.constructor : void 0) === Date) {
  ...
  MWSParamList = (function(_super) {
    ...
    MWSParamList.prototype.get = function() {
      var count, i, index, list, v, _i, _j, _len, _len1, _ref;
  ...
  MWSEnumList = (function(_super) {
    ...
    MWSEnumList.prototype.set = function(values) {
      ...
      for (_i = 0, _len = values.length; _i < _len; _i++) {
        val = values[_i];
        if (__indexOf.call(this.members, val) >= 0) {
          _results.push(this.value[val] = true);
        } else {
          throw "Invalid enumeration value, '" + val + "', must be a member or index of " + this.members;
        }
      }
  ...
  MWSComplexParam = (function(_super) {
    ...
    MWSComplexParam.prototype.render = function(obj) {
      ...
      for (k in _ref) {
        p = _ref[k];
        n = (_ref1 = p.name) != null ? _ref1 : k;
        v = (_ref2 = typeof p.get === "function" ? p.get() : void 0) != null ? _ref2 : p.value;
        if (v != null) {
          obj["" + this.name + "." + n] = v;
        } else if (p.required) {
    ...
    MWSComplexParam.prototype.get = function(field) {
      var k, obj, p, _ref, _ref1, _results;
    ...
    MWSComplexParam.prototype.set = function(field, value) {
      var k, v, _ref, _results, _results1;
