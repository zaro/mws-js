  ...
  ReportsClient = (function(_super) {
    ...
    ReportsClient.prototype.requestReport = function(options, cb) {
      ...
      return this.invoke(req, {}, (function(_this) {
        return function(res) {
          var reportReqInfo, _ref, _ref1;
          reportReqInfo = (_ref = (_ref1 = res.result) != null ? _ref1.ReportRequestInfo : void 0) != null ? _ref : null;
    ...
    ReportsClient.prototype.getReportRequestList = function(options, cb) {
      ...
      return this.invoke(req, {
        ...
        return function(res) {
          var reportReqInfoList, _ref, _ref1;
          reportReqInfoList = (_ref = (_ref1 = res.result) != null ? _ref1.ReportRequestInfo : void 0) != null ? _ref : null;
    ...
    ReportsClient.prototype.getReportRequestCount = function(options, cb) {
      ...
      return this.invoke(req, {}, (function(_this) {
        return function(res) {
          ...
          count = (_ref = (_ref1 = res.result) != null ? _ref1.Count : void 0) != null ? _ref : null;
          return cb(count, res);
        };
      })(this));
    };
    ...
    ReportsClient.prototype.cancelReportRequests = function(options, cb) {
      ...
      return this.invoke(req, {}, (function(_this) {
        return function(res) {
          var canceledReportReqInfoList, _ref, _ref1;
          canceledReportReqInfoList = (_ref = (_ref1 = res.result) != null ? _ref1.ReportRequestInfo : void 0) != null ? _ref : null;
    ...
    ReportsClient.prototype.getReportList = function(options, cb) {
      ...
      return this.invoke(req, {
        ...
        return function(res) {
          var reportInfo, _ref, _ref1;
          reportInfo = (_ref = (_ref1 = res.result) != null ? _ref1.ReportInfo : void 0) != null ? _ref : null;
    ...
    ReportsClient.prototype.manageReportSchedule = function(options, cb) {
      ...
      return this.invoke(req, {}, (function(_this) {
        return function(res) {
          var reportSchedules, _ref, _ref1;
          reportSchedules = (_ref = (_ref1 = res.result) != null ? _ref1.ReportSchedule : void 0) != null ? _ref : null;
    ...
    ReportsClient.prototype.getReportScheduleList = function(options, cb) {
      ...
      return this.invoke(req, {
        ...
        return function(res) {
          var reportSchedule, _ref, _ref1;
          reportSchedule = (_ref = (_ref1 = res.result) != null ? _ref1.ReportSchedule : void 0) != null ? _ref : null;
